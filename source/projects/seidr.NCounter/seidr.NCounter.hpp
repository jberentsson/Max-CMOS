...
public:
	...
	outlet<>* outputs[10] = {&output_0, &output_1, &output_2, &output_3, &output_4, &output_5, &output_6, &output_7, &output_8, &output_9};

	argument<symbol> bang_arg {this, "bang_on", "Initial value for the bang attribute.", MIN_ARGUMENT_FUNCTION {bang_enabled = FALSE;
}
}
;

argument<symbol> output_type_arg {
	this, "output_type", "Initial value for the greeting attribute.", MIN_ARGUMENT_FUNCTION {output_type = arg;
}
}
;
...
message<> bang {this, "bang", "Steps the counter.", MIN_FUNCTION {if (this->already_banged) {this->counter.step();
}
else {
