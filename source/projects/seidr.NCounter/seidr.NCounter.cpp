...
int NCounter_MAX::counter_value() { return this->counter.value(); }

int NCounter_MAX::set_preset(int p) { return this->counter.set_preset(p); }

int NCounter_MAX::preset() { return this->counter.preset(); }

int NCounter_MAX::step() { return this->counter.step(); }
