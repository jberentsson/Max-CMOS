...
void BinaryCounter_MAX::enable_bangs() {
    this->bang_enabled = TRUE;
}

void BinaryCounter_MAX::disable_bangs() {
    this->bang_enabled = FALSE;
}

int BinaryCounter_MAX::counter_value() {
    return this->counter.value();
}

int BinaryCounter_MAX::set_preset(int p){
    return this->counter.set_preset(p);
}

int BinaryCounter_MAX::preset(){
    return this->counter.preset();
}

int BinaryCounter_MAX::max_value(){
